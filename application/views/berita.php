              ...
              <li>
                <div class="photo_grid">
                  <figure class="effect-layla">
                    <img src="<?php echo base_url();?>assets/image/<?php echo $key5->gambar_berita;?>" alt=""/>
                  </figure>
                  <p>
                     <a href="<?php echo site_url("home/berita1?id=".$key5->id_berita);?>" ><?php echo $key5->nama_berita; ?></a>
                   </p>
                   <br/>
                </div>
              </li>
