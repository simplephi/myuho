              ...
              <li>
                <div class="photo_grid">
                  <figure class="effect-layla">
                    <img src="<?php echo base_url();?>assets/agenda/<?php echo $key8->gambar;?>" alt=""/>
                  </figure>
                  <p>
                     <a href="<?php echo site_url("home/agenda1?id=".$key8->id_agenda);?>" ><?php echo $key8->judul; ?></a>
                   </p>
                   <br/>
