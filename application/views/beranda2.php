      ...
      <div id="navbar" class="navbar-collapse collapse">
       <ul class="nav navbar-nav main_nav">
          ...
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">TENTANG UHO</a>
              ...
              <li><a href="http://uho.ac.id/profil.php?read=4" target="_blank">SAMBUTAN REKTOR</a></li>
          ...
          <li><a href="unit.html" target="_blank">UNIT</a></li>

          <li><a href="publikasi.html" target="_blank">PUBLIKASI</a></li>

          <li><a href="lembaga.html"target="_blank">LEMBAGA</a></li>

          <li><a href="404.html"target="_blank">KEMAHASISWAAN</a></li>

		  <li><a href="contact.html"target="_blank">KONTAK</a></li>
  ...
  <section id="contentSection">
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <?php
                foreach ($pengumuman as $key1) {
                $id1=$key1->id_pengumuman;
                ?>
            <h1><?php echo $key1->judul; ?></h1>

            <div class="single_page_content"> <img class="img-center" src="<?php echo base_url()?>assets/pengumuman/<?php echo $key1->gambar;?>" alt="">
              <p><?php echo $key1->isi; ?></p>
            ...
            <div class="related_post">
              ...
              <ul class="spost_nav wow fadeInDown animated">
                <li>
                  <div class="media"> <a class="media-left" href="single_page.html"> <img src="<?php echo base_url();?>/assets/images/post_img1.jpg" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="single_page.html"> Aliquam malesuada diam eget turpis varius</a> </div>
                  </div>
                </li>
                <li>
                  <div class="media"> <a class="media-left" href="single_page.html"> <img src="<?php echo base_url();?>/assets/images/post_img2.jpg" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="single_page.html"> Aliquam malesuada diam eget turpis varius</a> </div>
                  </div>
                </li>
                <li>
      ...
      <nav class="nav-slit"> <a class="prev" href="#"> <span class="icon-wrap"><i class="fa fa-angle-left"></i></span>
        <div>
          <h3>City Lights</h3>
          <img src="<?php echo base_url();?>/assets/images/post_img1.jpg" alt=""/> </div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        <aside class="right_content">
          <div class="single_sidebar">
            ...
            <ul class="spost_nav">
              <li>
                <div class="media wow fadeInDown"> <a href="single_page.html" class="media-left"> <img alt="" src="<?php echo base_url();?>assets/images/post_img1.jpg"> </a>
                  <div class="media-body"> <a href="single_page.html" class="catg_title"> Aliquam malesuada diam eget turpis varius 1</a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="single_page.html" class="media-left"> <img alt="" src="<?php echo base_url();?>assets/images/post_img2.jpg"> </a>
