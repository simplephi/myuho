        ...
        <div class="left_content">
          <div class="single_page">
            ...
            <?php
                ...
                $id1=$key1->id_berita;
                ?>
            <h1><?php echo $key1->nama_berita; ?></h1>
            <div class="single_page_content"> <img class="img-center" src="<?php echo base_url()?>assets/image/<?php echo $key1->gambar_berita;?>" alt="">
              <?php

              ?>
              <p style="text-align:justify;"><?php echo $key1->ket_berita; ?></p>
