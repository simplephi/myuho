        ...
        <div class="left_content">
          <div class="single_page">
            ...
            <ul class="photograph_nav  wow fadeInDown">
              <?php
                  $no=1;
                   foreach ($pengumuman as $key6){

                    $id6=$key6->id_pengumuman;
              ?>
              <li>
                <div class="photo_grid">
                  <figure class="effect-layla">
                    <img src="<?php echo base_url();?>assets/pengumuman/<?php echo $key6->gambar;?>" alt=""/>
                  </figure>
                  <p>
                     <a href="<?php echo site_url("home/pengumuman1?id=".$key6->id_pengumuman);?>" ><?php echo $key6->judul; ?></a>
                   </p>
                   <br/>
